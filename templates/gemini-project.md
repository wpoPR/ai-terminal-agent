...
1. ❌ Write to `.ai-context/stack-config.md` - Generated by script
2. ❌ Write source code - Claude/Codex's responsibility
3. ❌ Activate all agents "just in case"
4. ❌ Analyze without reading context files first
5. ❌ Suggest agents that don't exist

---

## ✅ ALWAYS DO:

1. ✅ Read `.ai-context/stack-config.md` and `ai-handoff.md` FIRST
2. ✅ Create todo files for Claude (don't just describe tasks)
3. ✅ Aim for 8k-12k tokens when selecting agents
4. ✅ Output ready-to-copy prompts for Claude
5. ✅ Update `ai-handoff.md` with your status
